...
echo.	 
echo.^</body^>
echo.^</html^>)>public/main.php

echo ^<? //startPage > index.php
...
echo.$dbUsername = "";
echo.$dbPassword = "";
echo.$db = new PDO^("mysql:dbhost=$dbHost;$dbname=$dbName",$dbUsername,$dbPassword,array^(PDO::MYSQL_ATTR_INIT_COMMAND =^> "SET NAMES utf8"^)^);
echo.)>system/db.php
